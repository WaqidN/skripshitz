...
import com.example.abnormal.crimereport.activity.admin.DFdiperiksa;
...
public class DFpenipu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.df_penipu,container,false);
    }
